...
<body>
    ...
    <h1>Deletar de Usuários - IFSP</h1>
    <form action="deletar_usuario_exe.php" method="post">
        ...
        <div>
            ...
            <input placeholder="(18)99999-8888" type="tel" name="fone" id="fone" pattern="\([0-9]{2}\)[0-9]{5}-[0-9]{4}" value="<?php echo $row['fone_usuario'];?>"disabled="">
        </div>
        <div>
            <label for="senha">Senha</label>
            <input type="number" name="senha" id="senha" value="<?php echo $row['senha'];?>"disabled="">
        </div>
